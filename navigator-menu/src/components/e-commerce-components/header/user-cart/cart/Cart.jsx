import {CartList,CartHeadingContainer, H3,CartContent,EmptyCartParag} from './Cart.styles';
...
function Cart({isCartOpen}){
    ...
    return(
        <CartList style={isCartOpen ? {display: 'block'} : {display: 'none'}}>
            ...
            <CartContent>
                <div className="cart-item" style={{display: 'none'}}>
                    ...
                    <div className="delete-icon">
                        <svg id="delete-icon-svg" width="14" height="16">
                        <defs>
                            <path
