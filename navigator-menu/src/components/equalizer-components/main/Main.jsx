    ...
    return(
        <main>
            <DescriptionContainer>
                ...
                <Parag>A system audio equalizer specifically designed for Android and iOS. Freely tune the
            ...
            <OfferContainer style={{
                ...
                <PlanContainer>
                    <Headings>
                        <H2>Premium EQ</H2>
                        <HeadingsParag>Get expert-level control with a robust equalizer, volume mixer, and spatial audio. Take
                        your listening experience to a whole new level and access all our incredible features!</HeadingsParag>
                    </Headings>
                    <Prices>
                        <PricesParag>
