...
function UserDetails(){
    ...
    return(
        <div className="user-details-container dark">
                    <div className="left">
                    <div className="main-info">
                        <div>
                        <img id="profile-picture" src="./assets/octocat.png" alt="profile-picture" />
                        <h2>The Octocat</h2>
                        <h4 className="dark">@octocat</h4>
                        </div>
                        <div>
                        <p className="dark">Joined 25 Jan 2011</p>
                        </div>
                        <div>
                        <p className="dark">This profile has no bio</p>
                        </div>
                    </div>
                    </div>
                    <div className="right">
                    ...
                    <div className="contacts">
                        ...
                        <div id="location">
                            <span>
                            <svg className="dark" height="20" width="14" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <p className="dark">San Francisco</p>
                        </div>
                        <div id="github-link">
                            <span>
                            <svg className="dark" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                <path
                            ...
                            <p className="dark">https://github.blog</p>
                        </div>
                        </div>
                        ...
                        <div id="twitter">
                            ...
                            <p id="twitter-text">Not Available</p>
                        </div>
                        <div id="company">
                            <span>
                            <svg className="dark" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
