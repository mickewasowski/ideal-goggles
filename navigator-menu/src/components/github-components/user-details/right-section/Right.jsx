...
function Right(){
    ...
    const activeIconClasses = 'fill-githubSVGAndTextLightFill dark:fill-genericWhite';
    const activeTextClasses = 'text-githubSVGAndTextLightFill dark:text-genericWhite';
    const inactiveIconClasses = 'fill-githubSVGAndTextUnavailableLight';
    const inactiveTextClasses = 'text-githubSVGAndTextUnavailableLight';

    const blogActive = 'text-githubSVGAndTextLightFill cursor-pointer dark:text-genericWhite hover:underline hover:decoration-githubSVGAndTextLightFill hover:dark:decoration-genericWhite';
            ...
            <Contacts>
                <LeftContactsWrapper>
                    <DetailsWrapper>
                        <IconSpan>
                            <svg 
                                className={data.location ? activeIconClasses : inactiveIconClasses}
                                height="20" 
                                width="14" 
                        ...
                        <p 
                            className={data.location ? activeTextClasses : inactiveTextClasses}
                        >{data.location ? data.location : 'Not available'}</p>
                    </DetailsWrapper>
                    <DetailsWrapper>
                        <IconSpan>
                            <svg 
                                className={data.blog ? activeIconClasses : inactiveIconClasses}
                                height="20" 
                                width="20" 
                                xmlns="http://www.w3.org/2000/svg"
                            >
                        ...
                        <p 
                            className={data.blog ? blogActive : inactiveTextClasses}
                        >{data.blog ? data.blog : 'Not available'}</p>
                    </DetailsWrapper>
                </LeftContactsWrapper>
                <RightContactsWrapper>
                    <DetailsWrapper>
                        <IconSpan>
                            <svg 
                                className={data.twitterUsername ? activeIconClasses : inactiveIconClasses}
                                height="18" 
                                width="20" 
                                xmlns="http://www.w3.org/2000/svg"
                            >
                        ...
                        <p 
                            className={data.twitterUsername ? activeTextClasses : inactiveTextClasses}
                        >{data.twitterUsername ? data.twitterUsername : 'Not Available'}</p>
                    </DetailsWrapper>
                    <DetailsWrapper>
                        <IconSpan>
                            <svg 
                                className={data.company ? activeIconClasses : inactiveIconClasses}
                                height="20" 
                                width="20" 
                                xmlns="http://www.w3.org/2000/svg"
                            >
                        ...
                        <p 
                            className={data.company ? activeTextClasses : inactiveTextClasses}
                        >{data.company ? data.company : 'Not available'}</p>
                    </DetailsWrapper>
                </RightContactsWrapper>
            </Contacts>
        </Wrapper>
