...
function Right() {
  ...
  const activeIconClasses =
    'fill-githubSVGAndTextLightFill dark:fill-genericWhite';
  const activeTextClasses =
    'text-githubSVGAndTextLightFill dark:text-genericWhite';
        ...
        <LeftContactsWrapper>
          <DetailsWrapper>
            <IconSpan>
              <svg
                className={
                  data.location ? activeIconClasses : inactiveIconClasses
                }
                height="20"
                width="14"
            ...
            <p
              className={
                data.location ? activeTextClasses : inactiveTextClasses
              }
            >
        ...
        <RightContactsWrapper>
          <DetailsWrapper>
            <IconSpan>
              <svg
                className={
                  data.twitterUsername ? activeIconClasses : inactiveIconClasses
                }
                height="18"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <p
              className={
                data.twitterUsername ? activeTextClasses : inactiveTextClasses
              }
            >
              {data.twitterUsername ? data.twitterUsername : 'Not Available'}
            </p>
          </DetailsWrapper>
          <DetailsWrapper>
            <IconSpan>
              <svg
                className={
                  data.company ? activeIconClasses : inactiveIconClasses
                }
                height="20"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
