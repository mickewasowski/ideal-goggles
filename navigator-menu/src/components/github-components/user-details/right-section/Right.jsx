        ...
        <Wrapper>
            ...
            <Contacts>
                <LeftContactsWrapper>
                    <DetailsWrapper>
                        <IconSpan>
                            <svg className='fill-githubSVGAndTextLightFill dark:fill-genericWhite' height="20" width="14" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <DetailsWrapper>
                        <IconSpan>
                            <svg className='fill-githubSVGAndTextLightFill dark:fill-genericWhite' height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path
                ...
                <RightContactsWrapper>
                    <DetailsWrapper>
                        <IconSpan>
                            <svg className='fill-githubSVGAndTextUnavailableLight' height="18" width="20" xmlns="http://www.w3.org/2000/svg">
                                <path
